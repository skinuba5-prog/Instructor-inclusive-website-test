  ...
  return (
    <div>
      ...
      <section className="bg-[var(--canvas)] px-6 py-16 md:px-10 lg:py-24">
        <div className="mx-auto grid max-w-[1200px] grid-cols-1 gap-6 sm:grid-cols-2 lg:gap-8">
      ...
      <section className="bg-[var(--canvas)] px-6 py-20 text-center md:px-10 lg:py-28">
        <h2 className="display-lg max-w-[24ch] mx-auto text-[var(--ink)]">
